...
public class Sensor : MonoBehaviour
{
    ...
    [SerializeField]
    private Vector3 angles_euler_1;
    ...
    [SerializeField]
    private Vector3 transformUp2;

    [SerializeField]
    private Vector3 transformUp3;
    ...
    void Update()
    {
        ...
        //Debug.DrawRay(transform.position, accelerometer_custom, Color.yellow);
